...
terminal = "xterm -fg green -bg black -sl 10000"
editor = "vim"
...
-- {{{ Tags
-- Include tags.lua which contains definitions and settigs for all of the tags
require("tags")
-- }}}
...
mytextclock = awful.widget.textclock({ align = "right" },"%a %F, %H:%M " , 15)
